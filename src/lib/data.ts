...
export const tasks: Task[] = [
  ...
  { id: "13", title: "Post Monday Motivation", description: "Day 1 - LinkedIn post", assignee: "MarvelSquad", status: "Done", createdAt: "2026-03-02" },
];
...
export const contentItems: ContentItem[] = [
  ...
  { id: "9", title: "Monday Motivation: Human-AI Collaboration", notes: "Day 1 - Motivation & Industry Insights", script: "Monday Motivation: The future of AI isn't about replacing humans. It's about amplifying human potential. At MoonlightAI Solutions, we believe the best results come from human-AI collaboration. What's your take?", images: [], stage: "Published", status: "posted", platform: "LinkedIn", createdAt: "2026-03-02" },
];
